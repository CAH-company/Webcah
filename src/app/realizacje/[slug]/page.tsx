    ...
    <div className="min-h-screen text-white font-sans overflow-x-hidden" style={{ background: "#0a0a0a" }}>
      ...
      >
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-20 max-w-3xl">
            <p
              className="text-[10px] uppercase tracking-[0.35em] font-bold mb-6 brand-font"
              style={{ color: accent }}
            >
              O kliencie
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-16 mb-20">
            <div>
              <p
                className="text-[10px] uppercase tracking-[0.35em] font-bold mb-8 brand-font"
                style={{ color: accent }}
              >
                01 / Wyzwanie
              </p>
          ...
          <div>
            <p
              className="text-[10px] uppercase tracking-[0.35em] font-bold mb-12 brand-font"
              style={{ color: accent }}
            >
              03 / Efekty
            </p>
      ...
      >
        <div className="container mx-auto max-w-6xl pt-12">
          <p
            className="text-[10px] uppercase tracking-[0.35em] brand-font mb-8"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {others.map((item) => (
              ...
              >
                <p
                  className="text-[10px] uppercase tracking-widest brand-font mb-1 flex items-center gap-2"
                  style={{ color: "rgba(255,255,255,0.2)" }}
                >
                  {item.industry}
